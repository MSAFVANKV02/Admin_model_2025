  ...
  return (
    <div>
      ...
      {selectedData && (
        ...
        <div className="flex justify-between sm:flex-row flex-col gap-3">
          <Label className="text-sm text-textGray">Store Capacity (in cubic):</Label>
        ...
        <div className="flex justify-between sm:flex-row flex-col gap-3">
          ...
          <span>{selectedData.google_location || "N/A"}</span>
        </div>
        ...
        {/* In-House Product */}
        <div className="flex justify-between sm:flex-row flex-col gap-3">
          <Label className="text-sm text-textGray">In-House Product :</Label>
        ...
        <div className="border-t-2 pt-4 space-y-3">
          ...
          {/* Account Number */}
          <div className="flex justify-between sm:flex-row flex-col gap-3">
            <Label className="text-sm text-textGray">Account Number :</Label>
        ...
        <div className="flex justify-between sm:flex-row flex-col gap-3">
          <Label className="text-sm text-textGray">Store Capacity (in cubic meters) :</Label>
