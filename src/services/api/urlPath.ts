...
export const UPDATE_CUSTOMER_USER_URL = `/user_api/admin/update-user`;
export const DELETE_CUSTOMER_USER_URL = `/user_api/admin/delete-user`;
...
export const UPDATE_STORE_OR_SELLER_URL = `/user_api/admin/update-store`;
