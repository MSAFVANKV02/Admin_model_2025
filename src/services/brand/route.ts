import { CREATE_BRAND_URL, GET_BRAND_URL, HARD_DELETE_ALL_BRAND_URL, HARD_DELETE_SINGLE_BRAND_URL, SOFT_DELETE_SINGLE_BRAND_URL, UPDATE_BRAND_URL } from "@/types/urlPath";
...
export const soft_Delete_Single_Brand_Api = async (id:string) =>
  await API.put(`${SOFT_DELETE_SINGLE_BRAND_URL}/${id}`, { withCredentials: true });
...
export const hard_Delete_Single_Brand_Api = async (id:string) =>
  await API.delete(`${HARD_DELETE_SINGLE_BRAND_URL}/${id}`, { withCredentials: true });
