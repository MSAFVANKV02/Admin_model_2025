import { CREATE_CATEGORY_URL, GET_CATEGORY_URL, HARD_DELETE_ALL_CATEGORY_URL, HARD_DELETE_SINGLE_CATEGORY_URL, SOFT_DELETE_CATEGORY_URL, TOGGLE_CATEGORY_URL, UPDATE_CATEGORY_URL } from "@/types/urlPath";
