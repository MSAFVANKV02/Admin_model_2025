import { CREATE_NEW_COUPONS, DELETE_COUPONS, GET_ALL_COUPONS, GET_ALL_DATA_FOR_COUPONS, UPDATE_COUPONS } from "../api/coupon-urlPath";
...
// 2. update 
export const edit_Coupons_Api = async (data: Partial<ICouponType>,id:string) =>
